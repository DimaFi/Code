def sort_students_by_average(filename):
    ...
    # with open(r'D:\Code\Vault\Machine\4.1 Сортировки\sorted_students.txt', 'w') as file:
    with open('sorted_students.txt', 'w') as file:
        for student in students:
            line = f"{student[0]} {student[1]} {student[2]} {student[3]} " + " ".join(map(str, student[4]))
            file.write(line + '\n')

# sort_students_by_average(r'D:\Code\Vault\Machine\4.1 Сортировки\students.txt')
